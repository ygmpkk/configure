...
-- {{{ Variables
-- terminal = "urxvtc"
terminal = "xterm -font -gnu-unifont-medium-r-narmal--16-160-75-7-c-80-iso10640 bg black -fg white"
...
-- Clock
mytextclock = awful.widget.textclock("<span color='" .. beautiful.fg_em .. "'>%Y-%m-%d</span> @ %H:%M")
